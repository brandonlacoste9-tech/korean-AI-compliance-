...
template_env = Environment(
    loader=FileSystemLoader("app/email_templates"), autoescape=select_autoescape(["html", "xml"])
)
...
class EmailAutomation:
    ...
    def send_checklist_pdf(
        self, to_email: str, first_name: str, language: str = "ko", pdf_path: Optional[str] = None
    ) -> Dict:
        """
        ...
        try:
            ...
            if pdf_path:
                attachments.append(
                    {"filename": "Korean_AI_Compliance_Checklist.pdf", "path": pdf_path}
                )
    ...
    def _schedule_drip_campaign(
        self, to_email: str, first_name: str, language: str, sequence: str
    ) -> None:
        """
    ...
    def send_welcome_email(
        self, to_email: str, first_name: str, company_name: str, language: str = "ko"
    ) -> Dict:
    ...
    def send_trial_started(
        self, to_email: str, first_name: str, trial_end_date: str, language: str = "ko"
    ) -> Dict:
    ...
    def send_assessment_completed(
        self, to_email: str, first_name: str, risk_score: int, language: str = "ko"
    ) -> Dict:
...
def send_checklist_pdf_email(
    to_email: str, first_name: str, language: str = "ko", pdf_url: Optional[str] = None
) -> Dict:
    """
...
def trigger_email_sequence(
    to_email: str, first_name: str, sequence: str, language: str = "ko"
) -> Dict:
    """
